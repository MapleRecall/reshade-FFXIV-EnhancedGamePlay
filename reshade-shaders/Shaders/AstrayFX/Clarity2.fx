...
<
	...
	ui_min = 0; ui_max = 4;
	ui_label = "半径";
	ui_tooltip = "[0|1|2|3|4]更高的值将增加效果半径。";
	ui_step = 1.00;
> = 3;
...
<
	...
	ui_label = "偏移";
	ui_tooltip = "模糊半径的额外调整，增加设置值以增加半径。";
	ui_step = 1.00;
> = 8.00;
...
<
	ui_type = "combo";
	ui_label = "混合模式";
	ui_items = "柔光\0叠加\0强光\0正片叠底\0亮光\0线性光\0加法";
	ui_tooltip = "混合模式决定了清晰度遮罩如何应用于原图。";
> = 2;
...
<
	...
	ui_min = 0; ui_max = 255;
	ui_label = "混合暗阈值";
	ui_tooltip = "暗于此值的像素将被排除在效果之外。设置为50以对应中间色调。";
	ui_step = 5;
> = 50;
...
<
	...
	ui_min = 0; ui_max = 255;
	ui_label = "混合亮阈值";
	ui_tooltip = "亮于此值的像素将被排除在效果之外。设置为205以对应中间色调。";
	ui_step = 5;
> = 205;
...
<
	...
	ui_tooltip = "向清晰度遮罩[ClarityMask]添加抖动以减少条带";
> = 1.0;
...
<
	ui_type = "combo";
	ui_items = "无\0清晰度遮罩[ClarityMask]\0BlendIf遮罩\0模糊\0";
	ui_tooltip = "调整设置时的一些有用设置。";
> = 0;
#endif
...
<
	ui_type = "combo";
	ui_items = "ReShade必须重新加载以应用这些设置。\0UseClarityDebug=1可以激活这些设置。\0ClarityRGBMode=1将使Clarity运行于RGB模式而非亮度[Luma]模式。\0";
	ui_tooltip = "这些设置可以添加到设置选项卡的预处理器定义。";
> = 0;
