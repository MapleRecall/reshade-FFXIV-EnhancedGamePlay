...
uniform float pSSDOFadeEndNear <
    ui_label = "SSDO Draw Distance: Fade End Near";
...
uniform float pSSDOFadeStartNear <
    ui_label = "SSDO Draw Distance: Fade Start Near";
...
// *** ESSENTIALS ***
texture texColorLOD2 { Width = BUFFER_WIDTH; Height = BUFFER_HEIGHT; Format = RGBA8; MipLevels = 4; };
...
// *** EXTERNAL TEXTURES ***
texture texNoiseSSDO < source = "ssdonoise.png"; >
{
	Width = 4;
	Height = 4;
	Format = R8;
